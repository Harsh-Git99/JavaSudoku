...
public class UserInterfaceImpl implements IUserInterfaceContract.View,
    ...
    private static final String JAPANESE_SUDOKU ="数独";
    ...
    private void drawTitle(Group root) {
        Text title = new Text(260,35,SUDOKU);
        Text title2 = new Text(297,690,JAPANESE_SUDOKU);
    ...
    private void drawGridLines(Group root) {
        ...
        while (index < 8) {
            ...
            Rectangle verticalLines = getLine(
                    xAndY + 64 * index,
                    BOARD_PADDING,
                    BOARD_X_AND_Y,
                    thickness
            );
            Rectangle horizontalLines = getLine(
                    (int) BOARD_PADDING,
                    xAndY + 64 * index,
                    thickness,
                    (int)BOARD_X_AND_Y
    ...
    private Rectangle getLine(int x,
                              double y,
                              double height,
                              int width) {
